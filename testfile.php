...
$quote = Mage::getModel('sales/quote')->setStoreId(4);
//$quote = Mage::getModel('sales/quote')->load(85063);
//Customer information

//$customerEmail = "example@example.com";
$customerEmail = "abc.test@gmail.com";
...
$productIds = array(3831 => 1, 3830 => 1); //array('product_id' => 'qty')
...
$shippingAddressData->setShippingMethod('ups_GND')->setPaymentMethod('cashondelivery'); //Shipping is flatrate for this example

//Set payment method for the quote
$quote->getPayment()->importData(array('method' => 'cashondelivery')); //Payment is check and money order for this example
